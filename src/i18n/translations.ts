...
export const translations = {
  cs: {
    ...
    services: {
      webhostingNoLimit: {
        ...
        content: 'Získejte slevu 70% na Webhosting NoLimit s PHP 8.3, Node.js, Python, Ruby, MariaDB, PostgreSQL, MongoDB a dalšími technologiemi.',
      ...
      vps: {
        title: 'VPS ON',
        content: 'Virtuální privátní servery s 33% slevou. Vysoký výkon, SSD disky a vlastní konfigurace.',
      ...
      mailhosting: {
        title: 'Mailhosting',
        content: 'Profesionální e-mailové služby s 50% slevou. Včetně antivirové a antispamové ochrany.',
  ...
  en: {
    ...
    services: {
      webhostingNoLimit: {
        title: 'Webhosting NoLimit',
        content: 'Get 70% off on Webhosting NoLimit with PHP 8.3, Node.js, Python, Ruby, MariaDB, PostgreSQL, MongoDB, and other technologies.',
      ...
      vps: {
        title: 'VPS ON',
        content: 'Virtual private servers with 33% discount. High performance, SSD drives, and custom configuration.',
      ...
      mailhosting: {
        title: 'Mailhosting',
        content: 'Professional email services with 50% discount. Including antivirus and antispam protection.',
  ...
  pl: {
    ...
    services: {
      webhostingNoLimit: {
        title: 'Webhosting NoLimit',
        content: 'Otrzymaj 70% zniżki na Webhosting NoLimit z PHP 8.3, Node.js, Python, Ruby, MariaDB, PostgreSQL, MongoDB i innymi technologiami.',
      ...
      vps: {
        title: 'VPS ON',
        content: 'Wirtualne serwery prywatne z 33% zniżką. Wysoka wydajność, dyski SSD i własna konfiguracja.',
      ...
      mailhosting: {
        title: 'Mailhosting',
        content: 'Profesjonalne usługi e-mail z 50% zniżką. W tym ochrona antywirusowa i antyspamowa.',
  ...
  sk: {
    ...
    services: {
      webhostingNoLimit: {
        title: 'Webhosting NoLimit',
        content: 'Získajte zľavu 70% na Webhosting NoLimit s PHP 8.3, Node.js, Python, Ruby, MariaDB, PostgreSQL, MongoDB a ďalšími technológiami.',
      ...
      vps: {
        title: 'VPS ON',
        content: 'Virtuálne privátne servery s 33% zľavou. Vysoký výkon, SSD disky a vlastná konfigurácia.',
      ...
      mailhosting: {
        title: 'Mailhosting',
        content: 'Profesionálne e-mailové služby s 50% zľavou. Vrátane antivírusovej a antispamovej ochrany.',
  ...
  de: {
    ...
    services: {
      webhostingNoLimit: {
        title: 'Webhosting NoLimit',
        content: 'Erhalten Sie 70% Rabatt auf Webhosting NoLimit mit PHP 8.3, Node.js, Python, Ruby, MariaDB, PostgreSQL, MongoDB und weiteren Technologien.',
      ...
      vps: {
        title: 'VPS ON',
        content: 'Virtuelle private Server mit 33% Rabatt. Hohe Leistung, SSD-Festplatten und individuelle Konfiguration.',
      ...
      mailhosting: {
        title: 'Mailhosting',
        content: 'Professionelle E-Mail-Dienste mit 50% Rabatt. Inklusive Antivirus- und Antispam-Schutz.',
